...
const PhysicsTopics = [
  {
    ...
    link: '/docs/matematica/01-Aritmetica',
    year: 'Biennio',
  },
  {
    title: 'Algebra',
    ...
    link: '/docs/matematica/02-Algebra',
    year: '3° Anno',
  },
  {
    title: 'Geometria',
    ...
    link: '/docs/matematica/03-Geometria',
    year: '3° Anno',
  },
];
    ...
    <Layout title="Fisica" description="Programma di Fisica del Liceo Scientifico">
      ...
      <div className="hero hero--primary" style={{textAlign: 'center', padding: '4rem 0'}}>
        <div className="container">
          <h1 className="hero__title">Matematica</h1>
          <p className="hero__subtitle">
            Dall'aritmetica all'analisi.
          </p>
        </div>
      </div>
